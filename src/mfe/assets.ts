...
const UTILITY_ASSET_ROOT = "/_utilities/travel";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/travel/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/travel/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("travel");
