...
export const content: ToolLocaleContent<MiniAdventuresUI> = {
  slug: 'pronostico-mini-aventuras',
  title: 'Pronóstico de Mini Aventuras - Sal de la Rutina',
  ...
  ui: {
    ...
    adventures: [
      ...
      { id: 78, text: "Intenta caminar por encima de un bordillo sin caerte.", categoryId: "exploration" },
      { id: 79, text: "Dibuja un mapa de tu barrio de memoria.", categoryId: "creativity" },
      { id: 80, text: "Envía un mensaje a alguien que hace tiempo que no ves diciéndole que te has acordado de él.", categoryId: "social" },
      { id: 81, text: "Fíjate en cómo visten 5 personas diferentes y crea una historia para ellas.", categoryId: "observation" },
      { id: 82, text: "Aprende el nombre científico de tu animal favorito.", categoryId: "learning" },
      { id: 83, text: "Hazte un té o una infusión y bébetela saboreando cada sorbo.", categoryId: "wellness" },
      { id: 84, text: "Ve a una zona de tu ciudad que no sea comercial y pasea.", categoryId: "exploration" },
      { id: 85, text: "Observa los tipos de nubes y compáralos con un Atlas de nubes online.", categoryId: "observation" },
      { id: 86, text: "Escribe una carta a tu 'yo' de dentro de un año.", categoryId: "wellness" },
      { id: 87, text: "Prueba el pan de una cultura diferente (pita, naan, arepa...).", categoryId: "food" },
      { id: 88, text: "Intenta silbar una melodía completa.", categoryId: "creativity" },
      { id: 89, text: "Fíjate en los carteles de los locales antiguos que quedan en tu zona.", categoryId: "observation" },
      { id: 90, text: "Dona tres prendas de ropa que no hayas usado en un año.", categoryId: "social" },
      { id: 91, text: "Aprende a decir 'Hola' en 5 idiomas.", categoryId: "learning" },
      { id: 92, text: "Encuentra una estatua y dedica un minuto a mirar cada detalle de ella.", categoryId: "observation" },
      { id: 93, text: "Camina descalzo sobre hierba o arena durante unos minutos.", categoryId: "wellness" },
      { id: 94, text: "Pregunta en la carnicería o pescadería cuál es el producto de temporada.", categoryId: "food" },
      { id: 95, text: "Copia un dibujo sencillo de un artista que te guste.", categoryId: "creativity" },
      { id: 96, text: "Pasa por una tienda de cómics o de juegos de mesa solo para mirar.", categoryId: "exploration" },
      { id: 97, text: "Nota la temperatura del aire en tu piel al salir de casa.", categoryId: "observation" },
      ...
      { id: 164, text: "Haz una caminata de 15 minutos solo prestando atención a los tejados.", categoryId: "observation" },
      { id: 165, text: "Dibuja un animal inventado combinando dos que conozcas.", categoryId: "creativity" },
      { id: 166, text: "Aprende cómo se cultiva tu verdura favorita.", categoryId: "learning" },
      { id: 167, text: "Pregunta a alguien en el supermercado qué receta va a hacer con lo que lleva.", categoryId: "social" },
      { id: 168, text: "Nota el peso de tu ropa sobre tus hombros durante un minuto.", categoryId: "observation" },
      { id: 169, text: "Cierra los ojos e intenta recordar el plano de tu casa habitación por habitación.", categoryId: "wellness" },
      { id: 170, text: "Ve a una zona verde cerca de ti y quédate en silencio sepulcral.", categoryId: "exploration" },
      { id: 171, text: "Busca un tutorial sobre cómo leer el mapa de estrellas.", categoryId: "learning" },
      { id: 172, text: "Escribe tres cosas que te gustaría agradecerte a ti mismo hoy.", categoryId: "wellness" },
      { id: 173, text: "Prueba una combinación de alimentos extraña y mira si te gusta.", categoryId: "food" },
      { id: 174, text: "Intenta identificar un olor agradable mientras caminas por la calle.", categoryId: "observation" },
      { id: 175, text: "Pon a prueba tu equilibrio sobre una sola pierna durante 30 segundos cada una.", categoryId: "wellness" },
      { id: 176, text: "Hazle un dibujo rápido a alguien cercano y dáselo.", categoryId: "social" },
      { id: 177, text: "Aprende qué es un 'haiku' e intenta escribir uno.", categoryId: "creativity" },
      { id: 178, text: "Mira hacia atrás cuando vayas caminando y fíjate en la perspectiva.", categoryId: "observation" },
      { id: 179, text: "Pon un fondo de pantalla nuevo que te inspire en tu móvil o PC.", categoryId: "wellness" },
      { id: 180, text: "Ve a una papelería y compra una sola pegatina o sobre bonito.", categoryId: "exploration" },
      { id: 181, text: "Aprende qué planetas son visibles a simple vista esta semana.", categoryId: "learning" },
      { id: 182, text: "Intenta tararear una canción mientras te cepillas los dientes.", categoryId: "wellness" },
      { id: 183, text: "Fíjate en los tipos de ventanas que hay en tu calle.", categoryId: "observation" },
      { id: 184, text: "Escribe un mensaje anónimo de ánimo y ponlo tras el limpiaparabrisas de un coche.", categoryId: "social" },
      { id: 185, text: "Dibuja un círculo perfecto a mano alzada.", categoryId: "creativity" },
      { id: 186, text: "Mira una charla TED sobre un tema que desconozcas.", categoryId: "learning" },
      { id: 187, text: "Bebe tu bebida habitual pero a una temperatura distinta.", categoryId: "food" },
      { id: 188, text: "Toma un camino de vuelta a casa que incluya una cuesta o escaleras nuevas.", categoryId: "exploration" },
      { id: 189, text: "Observa a un insecto durante 3 minutos y nota su trayectoria.", categoryId: "observation" },
      { id: 190, text: "Medita 1 minuto justo antes de almorzar.", categoryId: "wellness" },
      { id: 191, text: "Lleva una libreta y apunta 3 cosas curiosas que escuches hoy.", categoryId: "observation" },
      { id: 192, text: "Busca un vídeo de relajación con sonidos de la naturaleza.", categoryId: "wellness" },
      ...
      { id: 195, text: "Come una fruta que debas pelar con las manos.", categoryId: "wellness" },
      { id: 196, text: "Busca el nombre de un pájaro local y trata de escucharlo cantar.", categoryId: "observation" },
      { id: 197, text: "Toma una foto de un reflejo en un cristal o charco.", categoryId: "creativity" },
      ...
      { id: 201, text: "Haz un avioncito de papel y lánzalo desde un punto alto.", categoryId: "creativity" },
      { id: 202, text: "Explora la sección de 'ofertas' de una tienda de ultramarinos y prueba algo.", categoryId: "food" },
      { id: 203, text: "Aprende un dato histórico sobre tu ciudad.", categoryId: "learning" },
      { id: 204, text: "Camina por el lado opuesto de la calle al que sueles ir.", categoryId: "exploration" },
      { id: 205, text: "Escribe una lista de 5 habilidades que tienes.", categoryId: "wellness" },
      { id: 206, text: "Pasa 5 minutos tarareando una melodía que te inventes.", categoryId: "creativity" },
      { id: 207, text: "Encuentra 3 elementos de metal en el exterior y tócalos.", categoryId: "observation" },
      { id: 208, text: "Aprende qué es un 'palíndromo' y encuentra 3 ejemplos.", categoryId: "learning" },
      { id: 209, text: "Haz un cumplido a un compañero sobre algo que no sea su trabajo.", categoryId: "social" },
      { id: 210, text: "Cierra los ojos y trata de ubicar mentalmente dónde está el norte.", categoryId: "observation" },
      ...
      { id: 214, text: "Averigua qué fruta es la más popular en el país más lejano que pienses.", categoryId: "learning" },
      { id: 215, text: "Fíjate en las formas de los pomos de las puertas.", categoryId: "observation" },
      { id: 216, text: "Inventa un nombre para un color que no exista.", categoryId: "creativity" },
      { id: 217, text: "Bebe un vaso de agua por cada café o refresco que tomes hoy.", categoryId: "wellness" },
      { id: 218, text: "Pregunta a alguien cómo aprendió su habilidad favorita.", categoryId: "social" },
      { id: 219, text: "Encuentra un objeto abandonado por la calle y piensa cómo llegó ahí.", categoryId: "observation" },
      { id: 220, text: "Busca un tutorial sobre cómo leer el lenguaje corporal.", categoryId: "learning" },
      { id: 221, text: "Prepara tu comida favorita de la infancia.", categoryId: "food" },
      { id: 222, text: "Escribe 3 cosas que te ilusionen de la próxima semana.", categoryId: "wellness" },
      { id: 223, text: "Haz un baile ridículo durante 2 minutos.", categoryId: "creativity" },
      { id: 224, text: "Busca un rincón sombrío de un parque y quédate allí.", categoryId: "exploration" },
      { id: 225, text: "Fíjate en el color de las bolsas que lleva la gente.", categoryId: "observation" },
      ...
      { id: 228, text: "Pregunta al camarero por su canción favorita del hilo musical.", categoryId: "social" },
      { id: 229, text: "Busca una planta que tenga las hojas de dos colores.", categoryId: "observation" },
      { id: 230, text: "Haz 3 minutos de saltos o ejercicio intenso.", categoryId: "wellness" },
      { id: 231, text: "Averigua quién fue el primer habitante famoso de tu ciudad.", categoryId: "learning" },
      { id: 232, text: "Fíjate en los modelos de coches en un semáforo durante 2 minutos.", categoryId: "exploration" },
      { id: 233, text: "Escribe una lista de 5 adjetivos que te describan positivamente.", categoryId: "wellness" },
      { id: 234, text: "Intenta recordar el nombre de tus compañeros de clase de primaria.", categoryId: "learning" },
      ...
      { id: 238, text: "Cierra los ojos y camina unos pasos en línea recta.", categoryId: "observation" },
      { id: 239, text: "Haz una foto a una señal de tráfico que te guste.", categoryId: "creativity" },
      { id: 240, text: "Pregunta a alguien joven qué término de jerga es el más nuevo.", categoryId: "social" },
      ...
      { id: 243, text: "Sonríe de forma exagerada frente al espejo durante 1 minuto.", categoryId: "wellness" },
      { id: 244, text: "Escribe 3 frases de gratitud en tu diario.", categoryId: "wellness" },
      { id: 245, text: "Busca un vídeo de un paisaje que te relaje.", categoryId: "wellness" },
      { id: 246, text: "Aprende el nombre de 3 constelaciones del hemisferio sur.", categoryId: "learning" },
      { id: 247, text: "Compra una postal y envíala por correo postal a alguien.", categoryId: "exploration" },
      { id: 248, text: "Fíjate en la cantidad de luz solar que entra en cada habitación.", categoryId: "observation" },
      { id: 249, text: "Haz una construcción sencilla con objetos que tengas a mano.", categoryId: "creativity" },
      { id: 250, text: "Pregunta a alguien qué es lo mejor que le ha pasado hoy.", categoryId: "social" },
      { id: 251, text: "Aprende a hacer un nudo de corbata diferente.", categoryId: "learning" },
      { id: 252, text: "Intenta identificar 3 olores diferentes en tu cocina.", categoryId: "observation" },
      { id: 253, text: "Ponte una canción infantil que te gustara de pequeño.", categoryId: "wellness" },
      { id: 254, text: "Ordena tus libros de una forma diferente.", categoryId: "wellness" },
      { id: 255, text: "Pregunta a un bibliotecario por una sección casi sin visitas.", categoryId: "exploration" },
      { id: 256, text: "Aprende 3 hitos de la historia de la aviación.", categoryId: "learning" },
      { id: 257, text: "Adivina qué hora es antes de mirar el reloj.", categoryId: "observation" },
      { id: 258, text: "Dibuja un mapa de tus sueños o metas.", categoryId: "creativity" },
      { id: 259, text: "Envía un mensaje amable a alguien con quien no trabajes a menudo.", categoryId: "social" },
      { id: 260, text: "Haz 10 respiraciones profundas antes de salir de casa.", categoryId: "wellness" },
      { id: 261, text: "Nota la suavidad o rugosidad de la tela de tu ropa.", categoryId: "observation" },
      ...
      { id: 264, text: "Aprende qué es un agujero negro en términos sencillos.", categoryId: "learning" },
      { id: 265, text: "Ve a un cementerio antiguo y lee los epitafios.", categoryId: "exploration" },
      { id: 266, text: "Fíjate en las piedras de las fachadas de tu zona.", categoryId: "observation" },
      ...
      { id: 269, text: "Pregunta en la oficina de turismo algo sobre tu ciudad.", categoryId: "exploration" },
      { id: 270, text: "Dibuja un monstruo con un sombrero gracioso.", categoryId: "creativity" },
      { id: 271, text: "Aprende de dónde viene la palabra 'salario'.", categoryId: "learning" },
      { id: 272, text: "Fíjate en el sonido del clic al abrir una puerta.", categoryId: "observation" },
      { id: 273, text: "Haz una lista de 5 películas que te harían llorar.", categoryId: "wellness" },
      { id: 274, text: "Cuenta a alguien la historia de un objeto especial de tu casa.", categoryId: "social" },
      { id: 275, text: "Bebe tu bebida favorita con una pajita.", categoryId: "food" },
      { id: 276, text: "Encuentra 10 objetos circulares en tu habitación.", categoryId: "observation" },
      { id: 277, text: "Lleva un sombrero hoy, aunque sea un rato.", categoryId: "wellness" },
      { id: 278, text: "Pregunta a tus abuelos qué les asustaba de niños.", categoryId: "social" },
      ...
      { id: 282, text: "Fíjate en las tipografías de los periódicos físicos.", categoryId: "observation" },
      { id: 283, text: "Escucha un disco de jazz en una tarea rutinaria.", categoryId: "learning" },
      { id: 284, text: "Toma una foto de un objeto cotidiano desde un ángulo extraño.", categoryId: "creativity" },
      { id: 285, text: "Visita un lugar de culto antiguo solo por su arquitectura.", categoryId: "exploration" },
      ...
      { id: 289, text: "Haz sonar tus nudillos conscientemente.", categoryId: "wellness" },
      { id: 290, text: "Prueba a escribir de derecha a izquierda.", categoryId: "learning" },
      { id: 291, text: "Encuentra un objeto de color púrpura fuera de casa.", categoryId: "observation" },
      { id: 292, text: "Nota el sabor de la pasta de dientes durante un minuto.", categoryId: "observation" },
      { id: 293, text: "Escribe una lista de 3 sueños que recuerdes.", categoryId: "wellness" },
      ...
      { id: 296, text: "Encuentra en un mapa un país del que no sepas nada.", categoryId: "learning" },
      { id: 297, text: "Dibuja un patrón de puntos en un papel.", categoryId: "creativity" },
      { id: 298, text: "Pregunta al frutero cuál es su fruta 'secreta' más dulce.", categoryId: "social" },
      { id: 299, text: "Nota el calor del sol a través de un cristal.", categoryId: "observation" },
    ...
    shareTemplate: "¡Acabo de recibir una Mini Aventura! 🗺️\n\n\"{text}\"\n\n¿Te atreves? Genera la tuya aquí: {url}"
  },
  seo: [
